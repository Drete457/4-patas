...
export const products: ProductItem[] = [
  ...
  { id: 'exo-ovo-pequenos-roedores', name: 'Ovo pequenos roedores', image: exoOvoPequenosRoedores, category: 'exotics', description: 'Comedouro interativo para exóticos feito de um rolo de papel higiênico e um bocado de espia.', price: 7, quantity: 1 },
  ...
  { id: 'people-amigurumi-mascote', name: 'Mascote Amigurumi', image: pAmigurumiMascote, category: 'people', subcategory: 'Amigurumi', description: 'Amigurumi em forma de pata do logo. Feito de linha e algodão.', price: 4, quantity: 1 },
