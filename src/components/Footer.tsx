      ...
      <div className="container-section py-10">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-neutral-900 dark:text-white">Canto das Patas & Pelos</p>
              <p className="text-xs text-neutral-500 dark:text-neutral-400">Hotel & produtos artesanais</p>
            </div>
          </div>
        ...
        <div className="pt-6 border-t border-neutral-200 dark:border-neutral-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400">© {new Date().getFullYear()} Canto das Patas & Pelos. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
