    ...
    <section id="contacto" className="section bg-gradient-to-br from-brand-primary/10 via-sand to-white dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-950">
      <div className="container-section text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a className="inline-flex items-center font-medium text-brand-primary hover:text-brand-primaryDark" href="https://www.google.com/maps/search/?api=1&query=Rua+Padre+Angelo+Firmino+da+Silva+Almada" target="_blank" rel="noopener noreferrer">Localização →</a>
        </div>
      </div>
    </section>
  );
